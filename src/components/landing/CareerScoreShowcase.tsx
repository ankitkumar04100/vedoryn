        ...
        <div className="grid lg:grid-cols-2 gap-16 items-center">
          <motion.div initial={{ opacity: 0, x: -30 }} whileInView={{ opacity: 1, x: 0 }} viewport={{ once: true }}>
            ...
            <h2 className="font-display text-4xl md:text-5xl font-bold mt-3 mb-6">
              Vedoryn{" "}
              <span className="text-gradient-royal">Career Score</span>
            </h2>
            ...
            <div className="grid grid-cols-2 gap-4">
              {[
                ...
                { range: "80–100", label: "Industry Ready", color: "bg-vedoryn-emerald/10 text-vedoryn-emerald" },
              ].map((tier) => (
                <motion.div key={tier.range} whileHover={{ scale: 1.05 }}
                  className={`px-4 py-3 rounded-lg ${tier.color} cursor-default transition-all royal-glow`}>
