...
import { ArrowDown, Brain, TrendingUp, Zap, CheckCircle2 } from "lucide-react";
...
const steps = [
  ...
  },
  {
    ...
    color: "bg-vedoryn-cyan text-primary-foreground",
  },
  {
    icon: TrendingUp,
    title: "Track & Predict",
  ...
  },
  {
    ...
    color: "bg-vedoryn-green text-primary-foreground",
  },
];
      ...
      <div className="container mx-auto px-4">
        ...
        >
          ...
          <h2 className="font-display text-4xl md:text-5xl font-bold mt-3 mb-4">
            Your Journey to{" "}
            <span className="text-gradient-score">Career Clarity</span>
          </h2>
        </motion.div>
